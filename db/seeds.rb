...
Plan.find_or_create_by(name:"silver").update_attributes(amount:1599,interval:'month')
Plan.find_or_create_by(name:"gold").update_attributes(amount:2599,interval:'month')
